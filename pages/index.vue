...
<template>
  <div class="absolute top-0 left-0 w-full">
    <video class="w-full" src="/public/video.mp4" muted autoplay loop></video>
  </div>
  <div class="p-6 sm:p-20 md:p-28">
    <div class="relative">
      <div class="flex justify-center text-5xl p-4">
        <p class="font-sans text-3xl font-bold text-orange-700 sm:text-5xl">REV-FILMS</p>
      </div>
      <Search/>
    </div>
  </div>
  <div class="flex flex-col relative bg-gradient-to-r from-blue-950 to-fuchsia-900 text-white" id="cont2">
    ...
    <div class="flex flex-wrap p-4 gap-4 sm:flex-nowrap">
      <MovieCard
